      ...
      <div className="absolute top-0 left-0 h-full bg-black/45 w-full -z-50 " aria-hidden="true"></div> 
       <div className="absolute top-0 left-0 h-full w-full flex flex-col justify-center px-8 md:px-16 lg:px-32">
        ...
        <div className="max-w-2xl">
          <h1 className="font-extrabold mt-4 text-6xl text-white text-balance">{content?.name || content?.original_title}</h1>
          ...
          <p className="mt-4 text-lg">{content.overview.length>250?content.overview.slice(0,200)+'...':content.overview}</p>
        </div>
